...
class PublicUsersApiTest(TestCase):
    ...
    Public Api that is not authenticated
    """
    ...
    def test_create_valid_user_success(self):
        ...
        # Payload is the object passed to the api when making the request
        payload = {
    ...
    def test_create_token_invalid_credentials(self):
        ...
        """
        create_user(email='test@emailprovided.com', password='testpassword')
        payload = {
            'email': 'test@emailprovider.com',
            'password': 'wrong',
            }
